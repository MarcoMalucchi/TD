...
BAUD = 115200
PARAMETERS = ["1.780","4.750","5.800"]    # o ["1.000", "2.000", "3.000"]
INIT = 1.5                # frequenza iniziale usato solo se PARAMETERS ha un solo elemento
REPEAT_N = 5              # usato solo se PARAMETERS ha un solo elemento
LOG_DURATION = 30          # durata logging in secondi per ogni parametro
# =========================
...
def main():
    ...
    try:
        ...
        for param in cmds:
            ...
            wait_for_state("busy")
            wait_for_state("available")
            print("Attendo stabilizzazione per 5 secondi...")
            time.sleep(5)   #attesa stabilizzazione
            #avvia logging
